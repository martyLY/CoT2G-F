...
def main():
    ...
    if training_args.do_predict:
        ...
        # rouge_desc = ""
        if data_args.predict_with_generate:
            # decoded_preds, decoded_labels = compute_metrics(pred_generations, pred_labels)
            decoded_preds = tokenizer.batch_decode(pred_generations, skip_special_tokens=True)
            # decoded_labels = tokenizer.batch_decode(labels, skip_special_tokens=True)
